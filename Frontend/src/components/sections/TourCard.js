...
export default function TourCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition hover:shadow-md">
      {/* Left accent */}
      <div className="absolute left-0 top-0 h-full w-1 bg-green-600/80" />
      ...
      <div className="p-5 pl-6">
        ...
        <div className="mb-3 flex flex-wrap items-center gap-3 text-sm text-gray-600">
          ...
          <span className="inline-flex items-center gap-1.5">
            <svg width="16" height="16" viewBox="0 0 24 24" className="text-green-600" fill="none">
        ...
        <footer className="mt-4 flex items-center justify-between">
          ...
          <a
            href={`/tours/${id}`}
            className="inline-flex items-center gap-1 rounded-full bg-green-600 px-3 py-1.5 text-sm font-medium text-white transition hover:bg-green-700"
          >
            View
