...
// Main component that renders a single destination card with details like name, rating, price, etc.
export default function DestinationCard({
  ...
  // Helper function to render price symbols ($) based on price level
...
return (
  <div className="flex">
    {/* Left column showing the numbered sequence and vertical line */}
    <div className="flex flex-col items-center mr-7">
      <h2 className="text-green-600 font-semibold text-lg mb-2">{number}</h2>
      <div className="bg-green-500 w-0.5 h-full rounded-b-lg" />
    </div>

    {/* Main content container for the destination card */}
    <div className={`flex overflow-hidden bg-white max-w-2xl my-8 gap-6 mr-1`}>
      <div className="">
        {/* Title */}
        ...
        <img
          src={imageUrl}
          alt={title}
          className="rounded-lg object-cover w-100 h-50 mb-3"
        />
        ...
        {/* Description (currently empty placeholder) */}
        <p className="text-gray-700 mb-4 leading-relaxed text-sm"></p>

        {/* Single info row: rating, price, distance, and duration */}
